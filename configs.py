...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','https://jsr-r8p0.onrender.com') else APP_NAME+'.herokuapp.com'
...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001931930999')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 20301415))
	API_HASH = os.environ.get("API_HASH", "f437d50de35414db31347a998e7f857f")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6686420334:AAHHGzn5naFOMN2sOxCcrMq9dAt3-N7zNE8")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "VibeCasmpmbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001772120203))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5863661087"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://samarthcasm:samarthcasm@cluster0.cmuxzuo.mongodb.net/?retryWrites=true&w=majority")
